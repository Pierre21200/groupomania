...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_Comments_posts_id` FOREIGN KEY (`postId`) REFERENCES `posts` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `posts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userId` int NOT NULL,
  `titlePost` varchar(100) COLLATE utf8_bin NOT NULL,
  `content` varchar(100) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Posts_userId` (`userId`),
  CONSTRAINT `fk_Posts_users_id` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
